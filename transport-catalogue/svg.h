...
namespace svg {
	...
	//Шаблонный базовый класс для контейнеров SVG
	...
	//Шаблонный класс для общих свойств SVG объектов
	...
	private:
		...
		std::vector<Point> vertex_points_;
	};
